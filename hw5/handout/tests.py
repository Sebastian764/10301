...
To run one test: python3 -m unittest tests.TestRandomInit.test_shape
To run one set of tests: python3 -m unittest tests.TestRandomInit
To run all tests: python3 -m unittest tests
"""
